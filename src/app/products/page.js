    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-linear-to-b from-gray-50 to-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20">
          ...
          {/* Search Bar */}
          <div className="mt-10 max-w-2xl flex justify-center items-center mx-auto">
            <div
              onClick={() => router.back()}
              className=" p-4 hidden lg:flex justify-center items-center gap-2 bg-white/50 backdrop-blur-lg shadow rounded-full border border-black/20"
            >
              <ChevronLeft className="w-6 h-6 text-black" />
              <p className="text-black line-clamp-1">Back</p>
            </div>

            <div className="relative w-full ">
              <input
                type="text"
                placeholder="Search rubies by name, SKU, or description..."
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="bg-white/50 backdrop-blur-lg rounded-full shadow-lg border border-black/20 flex items-center justify-center gap-2 py-4 px-6 w-full md:w-2xl"
              />
              {searchQuery && (
                <button
      ...
      {/* Main Content */}
      <div className="max-w-7xl mx-auto mb-16 px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="lg:hidden fixed bottom-6  left-0 right-0 z-40 px-4">
        <div className="w-full md:w-2xl mx-auto flex justify-between items-center">
          ...
          <button
            ...
            className="bg-white/50 backdrop-blur-lg rounded-full shadow-lg border border-black/20 flex items-center justify-center gap-2 py-4 w-2xl"
          >
